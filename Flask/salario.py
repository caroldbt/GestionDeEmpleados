...
def calcular_y_mostrar_salario(empleado):
        print(
            f"El salario de {empleado.nombre} es: {empleado.calcular_salario()}")
...
# Salida esperada: 70000
# Salida esperada: El salario de Juan es: 50000
calcular_y_mostrar_salario(empleado1)
# Salida esperada: El salario de Ana es: 70000
